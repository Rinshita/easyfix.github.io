...
if(isset($_REQUEST['rSignup'])){
    ...
    //Email Already Registered
    {
        ...
        if($result->num_rows == 1)
        {
            ...
            Email ID Already Registered</div>';
        }
        ...
        //Assigning User's Values to Variables
        {
            ...
            $sql = "INSERT INTO requesterlogin_db(r_name, r_email, r_password) 
...
<div class="form-group">
<i class="far fa-envelope"></i><label for="email" class="font-weight-bold pl-2">Email</label>
<input type="email" class="form-control" placeholder="Enter Email" name="rEmail">
<small class="form-text">We'll never share your email with anoyone</small>
</div>
<div class="form-group">
